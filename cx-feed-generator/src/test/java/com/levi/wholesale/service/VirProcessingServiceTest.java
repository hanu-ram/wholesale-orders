...
class VirProcessingServiceTest {
    @InjectMocks
    ...
    public static void beforeClass() {
        listAppenderForClass = getListAppenderForClass(VirProcessingService.class);
    }

    @BeforeEach
    void beforeEach() {
        ReflectionTestUtils.setField(virProcessingService, "virUnconfirmedErrorTopic", "TestTopic");
        ReflectionTestUtils.setField(virProcessingService, "offset", 0);
        ReflectionTestUtils.setField(virProcessingService, "limit", 5);
    }

    @Test
    void processVirUnconfirmedQuantity() throws IOException {
        ...
        when(scheduleLineEntryRepository.getVirUnconfirmedSchLineEntry(any(Timestamp.class), any(Pageable.class))).thenReturn(unconfirmedQuantityDetailsPage);
        ...
        verify(cxKafkaProducer).publishOrderDetailsToKafka(expectedJson, "test-line-entry-VIR", "TestTopic");

    }

    @Test
    void testProcessVirUnconfirmedQuantity_processMultiPageData() throws IOException {
        List<UnconfirmedQuantityDetails> unconfirmedQuantityDetailsList = new ArrayList<>();
        UnconfirmedQuantityDetails quantityDetails = getUnconfirmedQuantityDetails();
        unconfirmedQuantityDetailsList.add(quantityDetails);
        unconfirmedQuantityDetailsList.add(quantityDetails);
        ...
        when(scheduleLineEntryRepository.getVirUnconfirmedSchLineEntry(any(Timestamp.class), any(Pageable.class)))
        ...
        verify(cxKafkaProducer, times(6)).publishOrderDetailsToKafka(expectedJson, "test-line-entry-VIR", "TestTopic");

    }

    @Test
    void processVirUnconfirmedQuantity_throwRuntimeException_onJsonProcessingException() throws JsonProcessingException {
        List<UnconfirmedQuantityDetails> unconfirmedQuantityDetailsList = new ArrayList<>();
        UnconfirmedQuantityDetails quantityDetails = getUnconfirmedQuantityDetails();
        unconfirmedQuantityDetailsList.add(quantityDetails);
        Page<UnconfirmedQuantityDetails> unconfirmedQuantityDetailsPage = new PageImpl<>(unconfirmedQuantityDetailsList);
        ...
        Assertions.assertThrows(RuntimeException.class, () -> virProcessingService.processVirUnconfirmedQuantity(), "Test Exception");
    }

    @Test
    void processVirUnconfirmedQuantity_throwsRuntimeException_onIOException() throws IOException {
        List<UnconfirmedQuantityDetails> unconfirmedQuantityDetailsList = new ArrayList<>();
        UnconfirmedQuantityDetails quantityDetails = getUnconfirmedQuantityDetails();
        unconfirmedQuantityDetailsList.add(quantityDetails);
        Page<UnconfirmedQuantityDetails> unconfirmedQuantityDetailsPage = new PageImpl<>(unconfirmedQuantityDetailsList);
        ...
        doThrow(IOException.class).when(cxKafkaProducer).publishOrderDetailsToKafka("{}", "test-line-entry-VIR", "TestTopic");

        Assertions.assertThrows(RuntimeException.class,
                () -> virProcessingService.processVirUnconfirmedQuantity(), "Test Exception");
    }

    @Test
    void processVirUnconfirmedQuantity_ShouldNotSendInvalidDataToKafkaTopic() {
        List<UnconfirmedQuantityDetails> unconfirmedQuantityDetailsList = new ArrayList<>();
        UnconfirmedQuantityDetails quantityDetails = getUnconfirmedQuantityDetails();
        unconfirmedQuantityDetailsList.add(quantityDetails);
        Page<UnconfirmedQuantityDetails> unconfirmedQuantityDetailsPage = new PageImpl<>(unconfirmedQuantityDetailsList);
    ...
    @Test
    void processVirUnconfirmedQuantity_ShouldNotProcessNullData() throws IOException {
